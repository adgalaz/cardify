$(document).ready(function() {
  ...
  $('#step5').text('<link rel="stylesheet" href="https://cdn.rawgit.com/adgalaz/cardify/heidi/assets/css/main.css">');
  $('#step6').text('<script src="https://cdn.rawgit.com/adgalaz/cardify/heidi/src/index.js"></script>');
});
